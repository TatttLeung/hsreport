...
<h1><i class="fa fa-table"></i>得分明细</h1></div><!--box-title end-->
    <div class="box-content">
        ...
        <div class="box-search">
            <form action="<?php echo Yii::app()->request->url;?>" method="get">
                ...
                <label style="margin-right:10px;">
                    <span>文章：</span>
                    <input style="width:200px;" class="input-text" type="text" placeholder="文章名" name="article_name" value="<?php echo Yii::app()->request->getParam('article_name');?>">
                </label> 
      ...
      <button class="btn btn-blue" type="submit">查询</button>
        ...
        <div class="box-table">
            ...
            <table class="list">
                <thead>
                    <tr>
                        <th style="text-align:center"><?php echo $model->getAttributeLabel('finish_time');?></th>
                        ...
                        <th style="text-align:center"><?php echo $model->getAttributeLabel('article_name');?></th>
                        <th style="text-align:center"><?php echo $model->getAttributeLabel('test_type');?></th>
                        <th style="text-align:center"><?php echo $model->getAttributeLabel('question');?></th>
                ...
                <tbody>
                    ...
                    <tr>  
                         ...
                         <td style="text-align:center"><?php echo $v->finish_time; ?></td>
                        ...
                        <td style="text-align:center"><?php echo $v->article_name; ?></td>
