<?php
if (!isset($_REQUEST['clubtype'])) {$_REQUEST['clubtype']=0;}
?>
<div class="box">
    <div class="box-content">
        ...
        <div class="box-search">
            <form action="<?php echo Yii::app()->request->url;?>" method="get">
                ...
                <input type="hidden" name="clubtype" value="<?php echo $_REQUEST['clubtype'];?>">
            ...
            <table class="list">
                <thead>
                    <tr>
                        ...
                        <th >序号</th>
                        <th><?php echo $model->getAttributeLabel('TCOD');?></th>
                        <th><?php echo $model->getAttributeLabel('TCNAME');?></th>
                        <th><?php echo $model->getAttributeLabel('TMOB');?></th>
                        <th><?php echo $model->getAttributeLabel('TSCHOOL');?></th>
                        <th><?php echo $model->getAttributeLabel('TPOS');?></th>
                        <th><?php echo $model->getAttributeLabel('F_ROLECODE');?></th>
                        <th>操作</th>
                    </tr>
                </thead>
                <tbody>
...
?>
                    <tr>
                        ...
                        <td><?php echo $v->TCOD; ?></td>
                        <td><?php echo $v->TCNAME; ?></td>
                        <td><?php echo $v->TMOB; ?></td>
                        <td><?php echo $v->CLUB_NAME; ?></td>
                        <td><?php echo $v->TPOS; ?></td>
                        <td><?php echo $v->F_ROLECODE; ?></td>
                        <td>
