...
<div class="box">
    <div class="box-title c"><h1><i class="fa fa-table"></i>稿件一审》》<span style="color:DodgerBlue">未审稿件</span></h1>   </div><!--box-title end-->
    <div class="box-content">
        <div class="box-header">
            <a class="btn" href="javascript:;" onclick="we.reload();"><i class="fa fa-refresh"></i>刷新</a>
              
            <div class="main">
            <a class="btn" href="<?php echo $this->createUrl('Firstcountnumber'); ?>"><i ></i>显示已审稿件</a>
