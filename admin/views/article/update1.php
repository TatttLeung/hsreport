...
<div class="box">
    <div class="box-title c">
        <h1><i class="fa fa-table"></i>稿件一审</h1><span class="back"><a class="btn" href="http://localhost/index.php?r=article/firsttrial"><i class="fa fa-reply"></i>退出审核</a></span>
    </div>
    <!--box-title end-->
    <div class="box-detail">
            ...
            <div style="display:block;" class="box-detail-tab-item">
                ...
                <table>
                        ...
                        <td colspan="2">
                            <select name="status">
                                ...
                                <?php foreach ($status as $v) {
                                    if ($v->id == 2 || $v->id == 3 || $v->id == 5|| $v->id == 6) {; ?>
                    ...
                    <tr>
                        ...
                        <td colspan="8">
                            <?php echo $form->textField($model, 'opinion1', array('class' => 'input-text')); ?>
                            <?php echo $form->error($model, 'opinion1', $htmlOptions = array()); ?>
                        </td>
                    </tr>
                    <tr>
       ...
       <div class="box-detail-submit">还剩<?php echo $this->showremain(1)?>篇<button onclick="submitType='baocun'" class="btn btn-blue" type="submit">审核完成并继续</button><button class="btn" type="button" onclick="we.back();">重置</button>    
