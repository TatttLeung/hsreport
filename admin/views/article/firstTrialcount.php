...
<div class="box">
    <div class="box-title c"><h1><i class="fa fa-table"></i>稿件一审》》<span style="color:DodgerBlue">已审稿件</span></h1>   </div><!--box-title end-->
    <div class="box-content">
        <div class="box-header">
            <a class="btn" href="javascript:;" onclick="we.reload();"><i class="fa fa-refresh"></i>刷新</a>
           <div class="main">
            <a class="btn"  style="background-color: gray;"><i ></i>显示已审稿件</a>
            <a class="btn" href="<?php echo $this->createUrl('FirstTrial'); ?>"><i ></i>显示未审稿件</a>
             </div>
                     <a class="btn" href="<?php echo $this->createUrl('update1', array());?>" title="审核"><i class="fa fa-edit"></i>开始审核(待审<?php $index=0;foreach($article as $v){$index++;}echo $index;?>篇)</a>
   <div class="box-title c">   
    <h1>
<i class="right">今天审核稿件数量</i><i><?php echo $this->showtrialnumber(1)?></i>
</h1>
 </div>
...
?>
                    <tr>
                        ...
                        <td style='text-align: center;'><?php echo $v->firsttrialtime; ?></td>
