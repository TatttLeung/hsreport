...
<div class="box">
    <div class="box-title c">
        <h1><i class="fa fa-table"></i>稿件二审</h1><span class="back"><a class="btn" href="http://localhost/index.php?r=article/SecondTrial"><i class="fa fa-reply"></i>退出审核</a></span>
    </div>
    <!--box-title end-->
    <div class="box-detail">
            ...
            <div style="display:block;" class="box-detail-tab-item">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td colspan="8">
                            <?php echo $form->textField($model, 'opinion2', array('class' => 'input-text')); ?>
                            <?php echo $form->error($model, 'opinion2', $htmlOptions = array()); ?>
                        </td>
                    </tr>
                    <tr>
        ...
        <div class="box-detail-submit">还剩<?php echo $this->showremain(2)?>篇<button onclick="submitType='baocun'" class="btn btn-blue" type="submit">审核完成并继续</button><button class="btn" type="button" onclick="we.back();">重置</button></div>
